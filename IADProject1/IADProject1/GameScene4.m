...
-(void)didBeginContact:(SKPhysicsContact *)contact
{
    ...
    if (notBall.categoryBitMask == hole2Category)
    {
        ...
        [Achievements reportingAchievements:@"com.RavenDesign.labyrinth.level4Lose" percentComplete:50.0f];
    }
    ...
    if (notBall.categoryBitMask == winCategory)
    {
        ...
        [Achievements reportingAchievements:@"com.RavenDesign.labyrinth.level4Win" percentComplete:100.0f];
    }
